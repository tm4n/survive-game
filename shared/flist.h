...
uint flist<T>::add(T *e)
{
    ...
    {
		log (LOG_DEBUG_VERBOSE, "Doubling flist size");
        // increase size
        ...
        delete[] elem;
        elem = newelem;
		if (elem[0] == NULL) log(LOG_DEBUG_VERBOSE, "ERROR in COPY222222!!!!!\n\n\n\n\n");
	...
	log(LOG_DEBUG_VERBOSE, "ERROR in FLIST: more elements in list than possible");
    return 0;
}
