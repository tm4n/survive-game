...
public:
	enum class meshType : int { Crate = 1, Crate_damaged = 2, Generator = 3, Generator_glass = 4, 
		...
		Muzzleflash = 59, Colt = 60, Colt_hand = 61, Chainsaw = 62, Chainsaw_hand = 63, Wesson = 64, Wesson_hand = 65, HKSL8 = 66, HKSL8_hand = 67, Shotgun = 68, Shotgun_hand = 69, USAS12 = 70, USAS12_hand = 71,
