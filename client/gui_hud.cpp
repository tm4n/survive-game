...
gui_hud::gui_hud(GUI *gui, ResourceLoader *resources)
{
	...
	t = new Texture("100", resources->getFont(), c);
	...
	t = new Texture("50", resources->getFont(), c);
	ammo_txt_id = gui->addText(t, 1, 0.8f, 0.8f);
	gui->setCentered(ammo_txt_id, true);
	ammo_mag_txt_id = gui->addText(t, 1, 0.8f, 0.8f);
	gui->setCentered(ammo_txt_id, true);
